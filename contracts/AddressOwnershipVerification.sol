...
contract AddressOwnershipVerification {
    ...
    event RemoveRequestEvent(address indexed transactor, address indexed transacteedeposit);                 // Event is triggered when an unverified request is removed
    ...
    // Remove the contract's data from the blockchain and send current balance to _owner
    // This should be removed for live deployment
    function remove() {
